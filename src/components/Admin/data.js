...
const data = {
    menus: [
        {text: 'Bảng điều khiển', icon: <Assessment/>, link: '/admin/dashboard'},
        {text: 'Quản lý sản phẩm', icon: <Web/>, link: '/admin/product/listProduct'},
        {text: 'Quản lý kho', icon: <Web/>, link: '/admin/commodity/listCommodity'},
        {text: 'Điều khiển', icon: <GridOn/>, link: '/admin/control'}
    ],
    tablePage: {
        items: [
